...
e.addEventListener("mousedown",(function(e){0===e.button&&!1!==t(e)&&(addEventListener("mousemove",h),addEventListener("mouseup",i))}))},p={hsv:[0,100,100],hsl:[0,100,50],wheelDiameter:200,wheelThickness:20,handleDiameter:16,wheelReflectsSaturation:!0,onChange:function(){}},f=v.DOMMatrix||v.WebKitCSSMatrix||v.MSCSSMatrix,m=function(e,t){return e===t||e[0]===t[0]&&e[1]===t[1]&&e[2]===t[2]},g=function(){function i(e){var t=this
this.options=e,this.wheelDiameter=this.options.wheelDiameter||p.wheelDiameter,this.wheelThickness=this.options.wheelThickness||p.wheelThickness,this.handleDiameter=this.options.handleDiameter||p.handleDiameter,this.onChange=this.options.onChange||p.onChange,this.wheelReflectsSaturation=void 0!==this.options.wheelReflectsSaturation?this.options.wheelReflectsSaturation:p.wheelReflectsSaturation,this.rootElement=this.options.appendTo.appendChild(w("div","reinvented-color-wheel")),this.hueWheelElement=this.rootElement.appendChild(w("canvas","reinvented-color-wheel--hue-wheel")),this.hueWheelContext=this.hueWheelElement.getContext("2d"),this.hueHandleElement=this.rootElement.appendChild(w("div","reinvented-color-wheel--hue-handle")),this.svSpaceElement=this.rootElement.appendChild(w("canvas","reinvented-color-wheel--sv-space")),this.svSpaceContext=this.svSpaceElement.getContext("2d"),this.svHandleElement=this.rootElement.appendChild(w("div","reinvented-color-wheel--sv-handle")),this._redrawHueWheel=function(){t._redrawHueWheelRequested=!1
...
function w(e,t){var n=document.createElement(e)
return n.className=t,n}export{g as default}

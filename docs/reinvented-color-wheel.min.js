...
return 0===h?[0,0,0]:[t,100*(2*(n*=(h*=2)<=1?h:2-h)/(h+n)),100*((h+n)/2)]}
...
var a=function(e){4!==e.length&&5!==e.length||(e=function(e){for(var t="#",n=1;n<e.length;n++){var h=e.charAt(n)
t+=h+h}return t}(e))
...
return t<0?t+360:t}function c(e){return e<0?0:e>100?100:(10*e+.5|0)/10}function v(e){return"number"==typeof e&&isFinite(e)}var d="PointerEvent"in window?function(e,t,n){var h=!1
...
for(var a=0;a<360;a++)s.beginPath(),s.arc(n,n,h,(a-90.7)*i,(a-89.3)*i),s.strokeStyle="hsl("+a+r,s.stroke()},this.hueWheelContext.imageSmoothingEnabled=!1,this.svSpaceContext.imageSmoothingEnabled=!1,this._hsv=o(e.hsv?e.hsv:e.hsl?i.hsl2hsv(e.hsl):e.rgb?i.rgb2hsv(e.rgb):e.hex?i.rgb2hsv(i.hex2rgb(e.hex)):void 0,p.hsv),this._hsl=l(i.hsv2hsl(this._hsv)),this._rgb=i.hsv2rgb(this._hsv),this._hex=i.rgb2hex(this._rgb)
var n=function(e,n){var h=t._inverseTransform.multiply(new f([1,0,0,1,e,n]))
return{x:h.e,y:h.f}},h=function(e){t._inverseTransform=m(e)
...
r(e)},r),d(this.svSpaceElement,a,s),d(this.svHandleElement,a,s),this.redraw()}return Object.defineProperty(i.prototype,"hsv",{get:function(){return this._hsv},set:function(e){this._setHSV(e)},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"hsl",{get:function(){return this._hsl},set:function(e){this._setHSV(i.hsl2hsv(e))},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"rgb",{get:function(){return this._rgb},set:function(e){this._setHSV(i.rgb2hsv(e))},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"hex",{get:function(){return this._hex},set:function(e){this.rgb=i.hex2rgb(e)},enumerable:!0,configurable:!0}),i.prototype.setHSV=function(){this.hsv=arguments},i.prototype.setHSL=function(){this.hsl=arguments},i.prototype.redraw=function(){this.hueWheelElement.width=this.hueWheelElement.height=this.wheelDiameter,this.svSpaceElement.width=this.svSpaceElement.height=(this.wheelDiameter-2*this.wheelThickness)*Math.SQRT1_2
...
t.left=e.offsetLeft+e.offsetWidth*this._hsv[1]/100+"px",t.top=e.offsetTop+e.offsetHeight*(1-this._hsv[2]/100)+"px"},i.default=i,i.defaultOptions=p,i.hsv2hsl=t,i.hsl2hsv=e,i.hsv2rgb=h,i.rgb2hsv=n,i.rgb2hex=s,i.hex2rgb=a,i}()}()

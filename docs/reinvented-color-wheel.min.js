...
return 1===l?[s,o,a]:2===l?[a,o,s]:3===l?[a,s,o]:4===l?[s,a,o]:5===l?[o,a,s]:[o,s,a]}function i(e){var t,n=Math.round((t=e,0,255,Math.min(Math.max(t,0),255))).toString(16)
...
for(var o=0;o<360;o++)s.beginPath(),s.arc(n,n,h,(o-90.7)*i,(o-89.3)*i),s.strokeStyle="hsl("+o+r,s.stroke()},this.hueWheelContext.imageSmoothingEnabled=!1,this.svSpaceContext.imageSmoothingEnabled=!1,this._hsv=o(e.hsv?e.hsv:e.hsl?i.hsl2hsv(e.hsl):e.rgb?i.rgb2hsv(e.rgb):e.hex?i.rgb2hsv(i.hex2rgb(e.hex)):void 0,d.hsv),this._hsl=a(i.hsv2hsl(this._hsv)),this._rgb=i.hsv2rgb(this._hsv),this._hex=i.rgb2hex(this._rgb)
var n=function(e,n){var h=t._inverseTransform.multiply(new p("matrix(1,0,0,1,"+e+","+n+")"))
return{x:h.e,y:h.f}},h=function(e){t._inverseTransform=function(e){for(var t=[e];e=e.parentElement;)t.push(e)
for(var n=new p,h=t.length-1;h>=0;h--){var i=getComputedStyle(t[h]),r=i.transform
if(r&&"none"!==r){var s=i.transformOrigin.split(" ").map(parseFloat)
n=n.translate(s[0],s[1]).multiply(new p(r)).translate(-s[0],-s[1])}}return n.inverse()}(e)
...
h&&(this._hsl=[n[0],this._hsl[1],this._hsl[2]],this._redrawHueHandle(),this._updateSvBackground()),r&&(this._hsl=a(i.hsv2hsl(n)),this._redrawSvHandle(),this.wheelReflectsSaturation&&!this._redrawHueWheelRequested&&(requestAnimationFrame(this._redrawHueWheel),this._redrawHueWheelRequested=!0)),(h||r)&&(this._rgb=i.hsv2rgb(n),this._hex=i.rgb2hex(this._rgb),this.onChange(this))},i.prototype._redrawSvSpace=function(){this._updateSvBackground()
...
t.left=e.offsetLeft+e.offsetWidth*this._hsv[1]/100+"px",t.top=e.offsetTop+e.offsetHeight*(1-this._hsv[2]/100)+"px"},i.default=i,i.defaultOptions=d,i.hsv2hsl=t,i.hsl2hsv=e,i.hsv2rgb=h,i.rgb2hsv=n,i.rgb2hex=r,i.hex2rgb=s,i}())}()

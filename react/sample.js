...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // node_modules/pure-color/convert/hsl2hsv.js
  var require_hsl2hsv = __commonJS({
    "node_modules/pure-color/convert/hsl2hsv.js"(exports, module) {
  ...
  // node_modules/pure-color/convert/hsv2hsl.js
  var require_hsv2hsl = __commonJS({
    "node_modules/pure-color/convert/hsv2hsl.js"(exports, module) {
  ...
  // es/reinvented-color-wheel.js
  var import_hsl2hsv = __toModule(require_hsl2hsv());
  var import_hsv2hsl = __toModule(require_hsv2hsl());
  ...
  function rgb2hsv(rgb) {
    ...
    var delta = max - min;
    var h = delta && 60 * (max === r ? (g - b) / delta % 6 : max === g ? (b - r) / delta + 2 : (r - g) / delta + 4);
    return [
      h < 0 ? h + 360 : h,
      max && delta * 100 / max,
      max * 100 / 255
  ...
  function hsv2rgb(hsv) {
    ...
    var _0 = m * 255 + 0.5 | 0;
    var _h = h | 0;
    return _h === 1 ? [_x, _c, _0] : _h === 2 ? [_0, _c, _x] : _h === 3 ? [_0, _x, _c] : _h === 4 ? [_x, _0, _c] : _h === 5 ? [_c, _0, _x] : [_c, _x, _0];
  }

  // es/reinvented-color-wheel.js
  var import_rgb2hex = __toModule(require_rgb2hex());
  var import_hex = __toModule(require_hex());
  ...
  function normalizePercentage(value) {
    return value < 0 ? 0 : value > 100 ? 100 : (value * 10 + 0.5 | 0) / 10;
  }
  ...
  var inverseTransform = function(element) {
    ...
    for (var i = ancestors.length - 1; i >= 0; i--) {
      ...
      if (transform && transform !== "none") {
        ...
        matrix = matrix.translate(transformOrigin[0], transformOrigin[1]).multiply(new Matrix(transform)).translate(-transformOrigin[0], -transformOrigin[1]);
      }
    }
  ...
  var ReinventedColorWheel = function() {
    function ReinventedColorWheel2(options) {
      var _this = this;
      ...
      this.wheelReflectsSaturation = this.options.wheelReflectsSaturation !== void 0 ? this.options.wheelReflectsSaturation : defaultOptions.wheelReflectsSaturation;
      ...
      this._hsv = normalizeHsvOrDefault(options.hsv ? options.hsv : options.hsl ? ReinventedColorWheel2.hsl2hsv(options.hsl) : options.rgb ? ReinventedColorWheel2.rgb2hsv(options.rgb) : options.hex ? ReinventedColorWheel2.rgb2hsv(ReinventedColorWheel2.hex2rgb(options.hex)) : void 0, defaultOptions.hsv);
      this._hsl = normalizeHsl(ReinventedColorWheel2.hsv2hsl(this._hsv));
      this._rgb = ReinventedColorWheel2.hsv2rgb(this._hsv);
    ...
    Object.defineProperty(ReinventedColorWheel2.prototype, "hsv", {
      get: function() {
        return this._hsv;
      },
      set: function(value) {
    ...
    Object.defineProperty(ReinventedColorWheel2.prototype, "hsl", {
      get: function() {
        return this._hsl;
      },
      set: function(value) {
        tripletsAreEqual(this._hsl, value) || this._setHSV(ReinventedColorWheel2.hsl2hsv(value));
      },
      enumerable: false,
      configurable: true
    });
    Object.defineProperty(ReinventedColorWheel2.prototype, "rgb", {
      get: function() {
        return this._rgb;
      },
      set: function(value) {
        tripletsAreEqual(this._rgb, value) || this._setHSV(ReinventedColorWheel2.rgb2hsv(value));
      },
      enumerable: false,
      configurable: true
    });
    Object.defineProperty(ReinventedColorWheel2.prototype, "hex", {
      get: function() {
        return this._hex;
      },
      set: function(value) {
        this._hex !== value && (this.rgb = ReinventedColorWheel2.hex2rgb(value));
      },
      enumerable: false,
      configurable: true
    });
    ReinventedColorWheel2.prototype.setHSV = function() {
      this.hsv = arguments;
    };
    ReinventedColorWheel2.prototype.setHSL = function() {
      this.hsl = arguments;
    };
    ReinventedColorWheel2.prototype.redraw = function() {
    ...
    ReinventedColorWheel2.prototype._setHSV = function(hsv) {
      ...
      if (svChanged) {
        this._hsl = normalizeHsl(ReinventedColorWheel2.hsv2hsl(newHsv));
        this._redrawSvHandle();
      ...
      if (hueChanged || svChanged) {
        this._rgb = ReinventedColorWheel2.hsv2rgb(newHsv);
        this._hex = ReinventedColorWheel2.rgb2hex(this._rgb);
        this.onChange(this);
      }
    };
    ReinventedColorWheel2.prototype._redrawSvSpace = function() {
      this._updateSvBackground();
    ...
    ReinventedColorWheel2.prototype._updateSvBackground = function() {
      this.svSpaceElement.style.backgroundColor = "hsl(" + this._hsv[0] + ",100%,50%)";
    };
    ReinventedColorWheel2.prototype._redrawHueHandle = function() {
    ...
    ReinventedColorWheel2.prototype._redrawSvHandle = function() {
    ...
    ReinventedColorWheel2.default = ReinventedColorWheel2;
    ReinventedColorWheel2.defaultOptions = defaultOptions;
    ReinventedColorWheel2.hsv2hsl = import_hsv2hsl.default;
    ReinventedColorWheel2.hsl2hsv = import_hsl2hsv.default;
    ReinventedColorWheel2.hsv2rgb = hsv2rgb;
    ReinventedColorWheel2.rgb2hsv = rgb2hsv;
    ReinventedColorWheel2.rgb2hex = import_rgb2hex.default;
    ReinventedColorWheel2.hex2rgb = import_hex.default;
    return ReinventedColorWheel2;
  }();
  var reinvented_color_wheel_default = ReinventedColorWheel;
  ...
  var react_default = ({ wheelThickness, wheelDiameter, handleDiameter, wheelReflectsSaturation, onChange, hsv, hsl, rgb, hex }) => {
    ...
    React.useEffect(() => {
      if (wheel) {
        ...
        wheelRef.current = new reinvented_color_wheel_default({
          wheelThickness,
          wheelDiameter,
          handleDiameter,
  ...
  var App = () => {
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", {
      ...
      onChange: (e) => setWheelReflectsSaturation(e.target.checked)
    }), "wheelReflectsSaturation")), /* @__PURE__ */ import_react.default.createElement(react_default, {
      hex,
      wheelDiameter,
      wheelThickness,
      handleDiameter,
